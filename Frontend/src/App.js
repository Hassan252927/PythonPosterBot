...
const App = () => {
    ...
    const uploadAndGenerate = async () => {
        ...
        try {
            ...
            const response = await fetch("http://pythonposterbot-production.up.railway.app/generate_posters", {
                method: "POST",
                body: formData
            });
                ...
                {outputImages.map((image, index) => {
                    ...
                    return (
                        <div key={index} style={{ textAlign: "center" }}>
                            ...
                            <img
                                src={`http://pythonposterbot-production.up.railway.app/static/output/${image}`}
                                alt={`Poster ${index + 1}`}
                                style={{
                                    width: "100%",
                                    maxWidth: "400px",
